...
const Home = () => {
  return (
    <div className="flex items-center justify-center mx-auto bg-gradient-to-r from-[#4676e6] to-[#63b1c9]">
      <Menu>
        <MenuButton>
        ...
        <MenuItems
          anchor="bottom"
          className="border-indigo-900 border-2 bg-indigo-700 text-white flex flex-col  gap-3  "
        >
          <MenuItem>
            <a
      ...
      <div
        id="dropdownHover"
        className="z-10 bg-red-200 divide-y divide-gray-500 rounded-lg shadow w-44 dark:bg-gray-700"
      >
        <ul
        ...
        >
          <li>
            <a
              href="#"
              className="block px-4 py-2 hover:bg-gray-400 dark:hover:bg-gray-600 dark:hover:text-white"
            >
              Dashboard
            </a>
          </li>
     ...
     */}
      ...
      {/* <div className="hs-dropdown relative inline-flex">
        ...
        <div
          className="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-60 bg-white shadow-md rounded-lg mt-2 divide-y divide-gray-200"
          role="menu"
